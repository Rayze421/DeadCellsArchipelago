...
LOCATION_TABLE: Dict[str, dict] = {
    ...
    "Flamethrower Turret": {
        ...
        "sources": [{'biome': 'PrisonCorrupt', 'min_bc': 0, 'max_bc': 0, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Shocker'}, {'biome': 'Ossuary', 'min_bc': 0, 'max_bc': 255, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Shocker'}, {'biome': 'Crypt', 'min_bc': 0, 'max_bc': 0, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Shocker'}, {'biome': 'Tumulus', 'min_bc': 1, 'max_bc': 255, 'dlc': 'FatalFalls', 'type': 'blueprint_enemy', 'mob': 'Shocker'}],
    },
    "Cloud Outfit": {
        "id": 0x00CD, "region": "Checks", "type": "skin",
        "dlc": "", "min_bc": 3, "item": "PrisonerCloud", "rarity": "Rare",
        "sources": [{'biome': 'PrisonCorrupt', 'min_bc': 3, 'max_bc': 0, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Shocker'}, {'biome': 'Ossuary', 'min_bc': 3, 'max_bc': 255, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Shocker'}, {'biome': 'Crypt', 'min_bc': 3, 'max_bc': 0, 'dlc': '', 'type': 'blueprint_enemy', 'mob': 'Shocker'}, {'biome': 'Tumulus', 'min_bc': 3, 'max_bc': 255, 'dlc': 'FatalFalls', 'type': 'blueprint_enemy', 'mob': 'Shocker'}],
    },
    "Hattori's Katana": {
