...
LOCATION_RULES = [
    ...
    ("Prison Depths Exit", _has_any("Ossuary Unlock", ["Ancient Sewers Unlock, Progressive Stem Cell"])),
    ("Corrupted Prison Exit", _has_any("Ancient Sewers Unlock", "Progressive Stem Cell")),
    ("Insufferable Crypt Exit", _has_any("Slumbering Sanctuary Unlock", ["Graveyard Unlock", "Spider Rune"])),
    ("Stilt Village Exit", _has_any("Clock Tower Unlock", ["Forgotten Sepulcher Unlock", "Teleportation Rune"])),
    ("Slumbering Sanctuary Exit", _has_any("Clock Tower Unlock", ["Forgotten Sepulcher Unlock", "Teleportation Rune"])),
    ("Graveyard Exit", _has_any(["Forgotten Sepulcher Unlock", "Teleportation Rune"], ["Cavern Unlock", "Hand of the King Defeat", "Homunculus Rune"])),
    ...
    ("Fractured Shrines Exit", _has_any("Clock Tower Unlock", ["Forgotten Sepulcher Unlock", "Teleportation Rune"], ["Undying Shores Unlock", "Homunculus Rune"], ["Undying Shores Unlock", "Cultist Outfit"])),
