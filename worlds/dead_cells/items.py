...
ITEM_TABLE: Dict[str, tuple] = {
    ...
    "Fire Blast":              (0x0318, USFL, DLC_BASE),
    ...
    "Concierge Defeat":         (0x1700, PROG, DLC_BASE),
    "Conjunctivius Defeat":     (0x1701, PROG, DLC_BASE),
    "Mama Tick Defeat":         (0x1702, PROG, DLC_BAD_SEED),
    "Death Defeat":             (0x1703, PROG, DLC_PURPLE),   
    "Time Keeper Defeat":       (0x1704, PROG, DLC_BASE),
    "Scarecrow Defeat":         (0x1705, PROG, DLC_FATAL_FALLS),
    "Giant Defeat":             (0x1706, PROG, DLC_RISE_OF_GIANT),
    "Hand of the King Defeat":  (0x1707, PROG, DLC_BASE),
    "Queen Defeat":             (0x1708, PROG, DLC_BASE),
    "Dracula Defeat":           (0x1709, PROG, DLC_PURPLE),
    "Collector Defeat":         (0x170A, PROG, DLC_RISE_OF_GIANT)
}
