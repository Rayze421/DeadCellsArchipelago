...
ITEM_TABLE: Dict[str, tuple] = {
    ...
    "Drumstick":             (0x1008, FILR, DLC_BASE),
    "Carrot":                (0x1009, FILR, DLC_BASE),
    "Big ol' raddish":       (0x100A, FILR, DLC_BASE),
    "Guts":                  (0x100B, FILR, DLC_BASE),
    "Monster's Eye":         (0x100C, FILR, DLC_BASE),
    "Cherries":              (0x100D, FILR, DLC_BASE),
    "Watermelon":            (0x100E, FILR, DLC_BASE),
    "Pastry":                (0x100F, FILR, DLC_BASE),
    "Turkey":                (0x1010, FILR, DLC_BASE),
    "Le Croissant":          (0x1011, FILR, DLC_BASE),
    "La Baguette":           (0x1012, FILR, DLC_BASE),
    "Small Medkit":          (0x1013, FILR, DLC_BASE),
    "Large Medkit":          (0x1014, FILR, DLC_BASE),
    "Gruyère":               (0x1015, FILR, DLC_BASE),
    "Camembert":             (0x1016, FILR, DLC_BASE),
    "Flask Recharge":        (0x1017, FILR, DLC_BASE),
    "Cough Syrup":           (0x1018, FILR, DLC_BASE),
    "Small Cough Syrup":     (0x1019, FILR, DLC_BASE),
    "Liposuction":           (0x101A, FILR, DLC_BASE),

    # ── Precious Loot / Fillers ───────────────────────────────────────
    "Fragment of the Philosopher's Stone":  (0x1100, FILR, DLC_BASE),
    "Ruby":                                 (0x1101, FILR, DLC_BASE),
	...
	"Almost-Yourself Outfit":                         (0x1224, USFL, DLC_FATAL_FALLS),
	...
	"Volcanic Temporal Outfit":               (0x1236, USFL, DLC_BASE),
	...
	"Rocky Outfit":                           (0x1243, USFL, DLC_FATAL_FALLS),
	...
	"Winter Outfit":                          (0x1258, USFL, DLC_BASE),
	"Flying Alcoholic Outfit":                (0x1259, USFL, DLC_BASE),
	"Vessel's Outfit":                        (0x125A, USFL, DLC_BASE),
	...
	"ZERO Outfit":                            (0x1275, USFL, DLC_BASE),
    ...
    "Curse Trap":             (0x1500, TRAP, DLC_BASE),
    "Elite Trap":             (0x1501, TRAP, DLC_BASE),
    "Gold Trap":              (0x1502, TRAP, DLC_BASE),
    "Weapon Break Trap":      (0x1503, TRAP, DLC_BASE),
    "Reverse Trap":           (0x1504, TRAP, DLC_BASE),
    "Challenge Trap":         (0x1505, TRAP, DLC_BASE),
...
deadcells_item_groups = {
    ...
    "Biome Unlocks": {
        "Prison Depths Unlock",          
        "Corrupted Prison Unlock",       
        "Ossuary Unlock",                
        "Ancient Sewers Unlock",         
        "Insufferable Crypt Unlock",     
        "Stilt Village Unlock",          
        "Slumbering Sanctuary Unlock",   
        "Graveyard Unlock",              
        "Clock Tower Unlock",            
        "Forgotten Sepulcher Unlock",    
        "Clock Room Unlock",             
        "High Peak Castle Unlock",       
        "Derelict Distillery Unlock",    
        "Throne Room Unlock",            
        "Cavern Unlock",                 
        "Guardian's Haven Unlock",       
        "Astrolab Unlock",               
        "Observatory Unlock",            
        "Dilapidated Arboretum Unlock",  
        "Morass of the Banished Unlock", 
        "Nest Unlock",                   
        "Fractured Shrines Unlock",      
        "Undying Shores Unlock",         
        "Mausoleum Unlock",              
        "Infested Shipwreck Unlock",     
        "Lighthouse Unlock",             
        "Crown Unlock",                  
