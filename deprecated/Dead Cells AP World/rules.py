...
def set_all_rules(world: DeadCellsAPWorld) -> None:
...
def set_all_entrance_rules(world: DeadCellsAPWorld) -> None:
...
def set_all_location_rules(world: DeadCellsAPWorld) -> None:
...
def set_completion_condition(world: DeadCellsAPWorld) -> None:
