...
ITEM_NAME_TO_ID = {
    ...
    "Spite Sword Blueprint": 45,
    "Shovel Blueprint": 46,
    "Sadist's Stiletto Blueprint": 47,
    "Shrapnel Axes Blueprint": 48,
    "Seismic Strike Blueprint": 49,
    "War Spear Blueprint":50
}
...
DEFAULT_ITEM_CLASSIFICATIONS = {
    ...
    "Ram Rune": ItemClassification.progression,
...
# Subclass of Item for Dead Cell items
class DeadCellItem(Item):
    game = "Dead Cells"
